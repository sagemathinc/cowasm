...
- Change: schema 120 manifests extend the Node.js/Electron smoke contract with
...
- Change: schema 121 manifests extend the Node.js/Electron smoke contract with
  ...
  `sagelite-ok meson configure compile install node import electron resources smoke relocated followups recorded`.
- Change: schema 123 manifests extend the finite-field matrix smoke with
...
- Change: schema 133 manifests extend the Node.js/Electron matrix smoke with
  ...
  mandatory resource files are added.
- Change: schema 134 manifests extend the Node.js/Electron matrix mutation
...
- Change: schema 136 manifests extend the Node.js/Electron finite-field matrix
  ...
  resource files are added.
- Change: schema 137 manifests extend the same finite-field 3x3 matrix smoke
