...
cowasm_clang_standalone_run_wasi "$bin_dir" "$probe_dir/flint-test" |
  grep "flint-ok rational=1/2 bernoulli=-691/2730 factors=2 finite-field-factors=2 fq=gf9 mpoly=zmod7 q-mpoly=Qxy matrix-det=22 mod-solve=1,2,3 ball-poly=16 roots=+i,-i"
