...
const doctestRunnerVersion = 148;
...
def __cowasm_seed_common_doctest_globals(namespace):
    imports = (
        ...
        ("sage.topology.simplicial_complex", ("Simplex", "SimplicialComplex")),
        ("sage.topology.moment_angle_complex", ("MomentAngleComplex",)),
        ...
        ("sage.plot.plot", ("graphics_array", "list_plot_loglog")),
    ...
    try:
        ...
        namespace.setdefault("simplicial_complexes", simplicial_complexes)
        try:
            import sage.all as sage_all
