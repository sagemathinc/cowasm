...
#ifdef __wasilibc_unmodified_upstream_signal /* WASI has no ucontext support */
#ifdef _GNU_SOURCE
...
#ifdef __wasilibc_unmodified_upstream_signal /* WASI has no sigaction */
...
#ifdef __wasilibc_unmodified_upstream_signal /* WASI has no threads yet */
int pthread_sigmask(int, const sigset_t *__restrict, sigset_t *__restrict);
int pthread_kill(pthread_t, int);
#endif

#ifdef __wasilibc_unmodified_upstream_signal /* WASI has no siginfo */
