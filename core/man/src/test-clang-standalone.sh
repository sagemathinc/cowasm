...
clang_cflags="-fvisibility-main -D_WASI_EMULATED_GETPID -D_WASI_EMULATED_MMAN -I$compat_dir -I$posix_wasm_dir -I$zlib_dist_dir/include -Oz"
COWASM_TOOLCHAIN=clang "$bin_dir/cowasm-cc" \
  -I"$build_dir" $clang_cflags \
