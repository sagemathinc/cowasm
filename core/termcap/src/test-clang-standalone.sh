...
cowasm_clang_standalone_probe "termcap" "$bin_dir" "$probe_dir"
...
COWASM_TOOLCHAIN=clang make AR="$bin_dir/cowasm-ar" -j"$jobs" libtermcap.a
...
"$bin_dir/cowasm" "$probe_dir/termcap-test"
