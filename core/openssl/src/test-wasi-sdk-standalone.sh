...
if [ "$#" -ne 5 ]; then
  echo "usage: test-wasi-sdk-standalone.sh BUILD_DIR DIST_DIR BIN_DIR POSIX_WASM_DIR SRC_DIR" >&2
  exit 2
fi
...
cowasm_standalone_probe "openssl" wasi-sdk "$bin_dir" "$probe_dir"
...
#ifndef COWASM_OPENSSL_WASI_SDK_COMPAT_TERMIOS_H
#define COWASM_OPENSSL_WASI_SDK_COMPAT_TERMIOS_H
...
#ifndef COWASM_OPENSSL_WASI_SDK_COMPAT_NETDB_H
#define COWASM_OPENSSL_WASI_SDK_COMPAT_NETDB_H
...
#ifndef COWASM_OPENSSL_WASI_SDK_COMPAT_H
#define COWASM_OPENSSL_WASI_SDK_COMPAT_H
