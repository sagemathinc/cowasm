...
const _names = errno.constants.names ++ signal.constants.names ++ netdb.constants.names;
const _values = getValues(errno.constants) ++ getValues(signal.constants) ++ getValues(netdb.constants);
